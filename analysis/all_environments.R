...
resultsFile = "resultsRescaled" #also used to save pdf

#Factors
environments <- c("Ackley", "Cross-in-Tray", "Drop-wave", "Eggholder", "Griewank", "Holder table", "Langermann", "Levy", "Levy n.13", "Rastrigin", "Schaffer n.2", "Schaffer n.4", "Schwefel", "Shubert", "Mason & Watts (2012)", "N=20, K=5", "N=20, K=16")
